...
def detect_face(image, cascade_path):
    ...
    facerect = cascade.detectMultiScale(
        image_gray, scaleFactor=1.1, minNeighbors=3, minSize=(20, 20))
...
def start(video_path, cascade_path, save_dir='./images/original', extension='png',
          resize_size=(100, 100), fps=5,  resize=True, pad=False,):
    """動画から、画像の取得を開始する"""
...
if __name__ == '__main__':
    start('./images/movie.mp4', 'lbpcascade_animeface.xml')
